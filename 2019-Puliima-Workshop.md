...
![Prepare data](workshop/40-prepare.png)
...
![Training](workshop/100-training.png)
...
Now the model has been trained, on the **New Transcriptions** step, we can **Choose a file**. Then decide whether you want the transcription in text format or an Elan file with the words aligned. When you click a format button, the transcribing starts. The process can take time, depending on how long your audio is.
